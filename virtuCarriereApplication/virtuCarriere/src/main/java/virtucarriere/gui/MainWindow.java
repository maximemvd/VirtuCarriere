...
public class MainWindow extends JFrame {
  ...
  // <editor-fold defaultstate="collapsed" desc="Generated
    ...
    private void initComponents() {
        ...
        mouseCoordinates1 = new virtucarriere.gui.MouseCoordinates();
        ...
        drawingPanel.add(mouseCoordinates1, java.awt.BorderLayout.CENTER);
  ...
  private void drawingPanelMouseMoved(java.awt.event.MouseEvent evt) {
    ...
    Point mousePoint = evt.getPoint();
    mouseCoordinates1.setX((int)mousePoint.getX());
    mouseCoordinates1.setY((int)mousePoint.getY());
    mouseCoordinates1.repaint();
  }
  ...
  public void draw(Graphics2D g, DrawingPanel drawingPanel, double zoom) {
    ...
    private virtucarriere.gui.MouseCoordinates mouseCoordinates1;
